    ...
    page.on("framenavigated", async (frame) => {
      ...
      try {
        if (url.includes("id_token=")) {
          console.log("Found the URL with the id_token query parameter.");
          ...
          if (idToken) {
            ...
            console.log("Authentication flow complete. Closing browser.");
            await browser.close();
          ...
          if (code) {
            console.log("The URL contains the specified code query parameter.");
